...
# Read data
data_dir = r"C:\Users\hecht\OneDrive - Universität Heidelberg\Dokumente\_Studium\_Master\_2. Semester\DSML\Final Project\DSML_Final_Project\wu_git\influenza_transformer\data"

print(data_dir)
data = utils.read_data(data_dir, timestamp_col_name=timestamp_col)
print(data.head())
...
for epoch in range(epochs):
    ...
    with torch.no_grad():
        for i, (src, _, tgt_y) in enumerate(training_dataloader):
            ...
            loss = criterion(tgt_y, prediction)
            print(f"samples: {i}, Loss: {loss.item()}")

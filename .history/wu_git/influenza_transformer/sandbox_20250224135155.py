...
# Read data
data = utils_new.read_data(timestamp_col_name=timestamp_col)
...
training_indices = utils_new.get_indices_entire_sequence(
    data=training_data, 
...
src_mask = utils_new.generate_square_subsequent_mask(
...
tgt_mask = utils_new.generate_square_subsequent_mask( 
    dim1=output_sequence_length,
